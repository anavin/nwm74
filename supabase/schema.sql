...
insert into nm74.contracts (id,ord,code,name,contractor,amount,periods,vat,retention,end_date,bank) values
  ...
  ('c2',2,'อาคาร 3 ชั้น','มหาวิหารเก้าฟ้า (อาคารพักอาศัย)','บริษัท เอ พลัส แอสโซซิเอท จำกัด',21500000,15,7,5,'2027-04-15','กสิกรไทย สาขายูเนียนมอลล์ ลาดพร้าว · 763-2-09297-5 · บริษัท เอ พลัส แอสโซซิเอท จำกัด'),
...
-- contracts.amount เก็บ "เนื้องานก่อน VAT" — 23,005,000 คือยอดรวม VAT แล้ว
